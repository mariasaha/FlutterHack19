...
class Bar extends StatelessWidget {
  ...
  Bar(this._barWidth, this._cellHeight, this._cellDataList, this._strokeColor, this._strokeWidth);
  ...
  List<Widget> _populateCellWidgetList(List<CellData> cellDataList, double cellWidth) {
