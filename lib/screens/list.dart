        ...
        builder: (BuildContext context, AsyncSnapshot<List<ResourceModel>> list) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (BuildContext context, int inx) {
              ...
              final HardcodedResource hcr = HardcodedResource(r.title, r.reportedDifficulty.toDouble(), 7, r.averageRating.toInt(), r.dartVersion, r.flutterVersion, PrimaryType.video, r.tags, r.repoUrl, 89);
